...
<div class="row">
<div class="col-lg-12">
{{ Form::model($user, ['route' => ['admin.users.update', $user->username], 'role' => 'form', 'files' => true, 'method' => 'PUT']) }}
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title pull-left">{{ $user->username }} Edit</h4>
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            {{ Form::hidden('is_visible_email', $user->privacy ? $user->privacy->email : 0) }}
        ...
        <div class="form-group">
            ...
            {{ Form::hidden('is_visible_title', $user->privacy ? $user->privacy->title : 0) }}
        ...
        <div class="form-group">
            ...
            {{ Form::hidden('is_visible_first_name', $user->privacy ? $user->privacy->first_name : 0) }}
        ...
        <div class="form-group">
            ...
            {{ Form::hidden('is_visible_last_name', $user->privacy ? $user->privacy->last_name : 0) }}
        ...
        <div class="form-group">
            ...
            {{ Form::hidden('is_visible_gender', $user->privacy ? $user->privacy->gender : 0) }}
        ...
        <div class="form-group">
            ...
            {{ Form::hidden('is_visible_dob', $user->privacy ? $user->privacy->dob : 0) }}
