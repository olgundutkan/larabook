...
<div class="row">
    <div class="col-sm-12">
    	{{ Form::open(['route' => 'admin.users.store', 'id' => 'basicForm', 'class' => 'form-horizontal', 'files' => true, 'role' => 'form', 'method' => 'POST']) }}
        <div class="panel panel-default">
            ...
            <div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						{{ Form::select('groups[]', $groups, null, ['id' => 'groups', 'class' => 'form-control chosen-select', 'multiple'=>'multiple']) }}
					</div>
				</div>
