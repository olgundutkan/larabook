		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="col-md-12 text-center">
					<a href="{{ route('profile_path', $currentUser->username ? e($currentUser->username) : e($currentUser->full_name), $currentUser->username ? e($currentUser->username) : $currentUser->id) }}"> <img src="{{ e($currentUser->present()->profilePicture('x-large')) }}" class="img-responsive" alt="{{ $currentUser->username }}" style="margin:0 auto;"> </a>
				</div>
